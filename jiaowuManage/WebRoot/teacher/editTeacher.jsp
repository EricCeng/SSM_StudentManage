...
<body>
    <div class="main">
        ...
        <form:form action="tea/editTeacherSave" modelAttribute="entity">
            <fieldset>
                <legend>教师</legend>
                 <td><input type="hidden" name="id" value="${entity.id}"></td><br>
                    <td>教师名称：<input type="text" name="name" value="${entity.name}"></td><br>
                    <td>教师类别：<select type="text" name="usertype" >
                       <option value="3">普通教师</option>
                    </select></td><br>
        ...
        <p>
            <a href="homepage/welcome.jsp" class="abtn out">返回列表</a>
        </p>
